...
def getLatestShakemap():
    ...
    if response.status_code == 200:
        ...
        if count > 0:
            ...
            buildings = gpd.GeoDataFrame.from_postgis('SELECT * from point_sample', con, geom_col='geometry').to_crs('+proj=cea')
            ...
            if table is not None:
                if 'time' in table.columns:
                    ...
                    if count > 0:
                        ...
                        new_shakemap['buildings'] = new_shakemap['buildings'].astype('Int64')
